...
sealed class Content {
    ...
    fun alterCacheControl(
        ...
        is Text -> copy(cacheControl = cacheControl)
        is Image -> copy(cacheControl = cacheControl)
        is Document -> copy(cacheControl = cacheControl)
...
//            }
//            val bytesToSet = File(pathToSet).readBytes()
//            try {
//                bytes = bytesToSet
